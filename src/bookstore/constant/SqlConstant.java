...
public class SqlConstant {
    ...
    public static final String GET_LAST_BOOK_ID = "SELECT MAX(id) FROM Book";
    ...
    public static final String GET_LAST_ORDER_ID = "SELECT MAX(id) FROM BookOrder";
    ...
    public static final String GET_LAST_REQUEST_ID = "SELECT MAX(id) FROM BookRequest";
