...
-- -----------------------------------------------------
-- Table `expexchangeservice`.`LessonReview`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `expexchangeservice`.`LessonReview` (
...
-- -----------------------------------------------------
-- Table `expexchangeservice`.`CourseReview`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `expexchangeservice`.`CourseReview` (
...
-- -----------------------------------------------------
-- Table `expexchangeservice`.`LessonMembers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `expexchangeservice`.`LessonMembers` (
  `id_lesson` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `expexchangeservice`.`CourseMembers`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `expexchangeservice`.`CourseMembers` (
  `id_course` INT NOT NULL,
  `id_member` INT NOT NULL,
  INDEX `idCourse_idx` (`id_course` ASC) VISIBLE,
  INDEX `idMember_idx` (`id_member` ASC) VISIBLE,
